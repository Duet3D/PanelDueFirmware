...
ScreenHoming::ScreenHoming()
{
	...
	stop = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(1), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: STOP", 0, 0);
	status = new Status(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(2), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT);
...
ScreenFileLoaded::ScreenFileLoaded()
{
	...
	startOrClear = new ButtonDouble(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(1), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: START", "btn: CLEAR");
...
ScreenFault::ScreenFault()
{
	...
	clear = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(1), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: CLEAR", 0, 0);
	status = new Status(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(2), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT);
...
ScreenHeating::ScreenHeating()
{
	...
	stop = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(2), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: STOP", 0, 0);
	status = new Status(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(3), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT);
...
ScreenLoading::ScreenLoading()
{
	...
	cancel = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(1), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: CANCEL", 0, 0);
...
ScreenPrinter::ScreenPrinter()
{
	...
	plusMinus = new ButtonDouble(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(1), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: PLUS", "btn: MINUS");
	zCalibrate = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(2), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: ZCALIBRATE", 0, 0);
	indexCup = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(3), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: INDEXCUP", 0, 0);
	access = new Button(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(4), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: ACCESS", 0, 0);
	enterExit = new ButtonDouble(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(5), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: ENTER", "btn: EXIT");
...
ScreenZCalibrate::ScreenZCalibrate()
{
	...
	enterExit = new ButtonDouble(PROVEL_SCREENS_LINE_ROW(0), PROVEL_SCREENS_LINE_COL(3), PROVEL_SCREENS_LINE_WIDTH, PROVEL_SCREENS_LINE_HEIGHT, "btn: ENTER", "btn: EXIT");
